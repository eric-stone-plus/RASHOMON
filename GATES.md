...
**羅生門 metaphor**: Witnesses testify inside the gate. Truth is not in any single testimony — nor even in their aggregate. It emerges when one witness, reviewing *another's* account, spots what that witness could not see about themselves. 證 (shō) = testimony, evidence — the cross-examination that makes self-invisible errors visible.

**Failure mode**: Single-perspective bias — the error an agent cannot self-detect because it is standing inside the blind spot. Self-review is epistemologically closed; cross-review breaks that closure. R2 is not "four witnesses compared" — it is the mechanism by which each witness's invisible errors become visible to others who do not share that specific blindness.
