...
Routing: adversarial-review, direct-evidence, governance-boundary, or
human-review.
...
Escalation: records an unresolved residual. The governance-boundary instrument
or human review handles action boundaries when needed.
...
possible governance-boundary or human review when an action boundary is
involved.
...
scope, and action boundary. It is the boundary object shared by RASHOMON, the
adversarial review instrument, the governance-boundary instrument, direct
evidence, and human review.

System output: JSON-compatible trace with stable residual ids.

Routing: the governance-boundary instrument may consume the trace when a
protected action is proposed.
...
System output: governance-boundary route pairing report with trace refs, route
groups, metric deltas, pair verdict, and conservative recommendation.
...
**Rubicon Moment**
Transition point where adversarial review output crosses into executable
action.

The governance-boundary instrument evaluates the residual trace, the action
boundary, risk, reversibility, and authorization.
...
available, and governance-boundary blocking when high-risk residuals remain
open.
...
**Governance-Boundary Instrument**
...
- Adversarial review instrument: adversarial cross-examination and residual
  ledger production.
...
- Governance-boundary instrument: route binding, authorization, residual
  closure, process guard, and protected-action blocking.
