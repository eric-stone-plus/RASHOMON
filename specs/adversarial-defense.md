...
action boundary, the governance-boundary instrument consumes the residual
trace. Its Protected-Write Guard may block if high-risk residuals remain open
or if their closure evidence is missing.
...
- governance-boundary instrument closure specification - protected-action closure gate
