...
These metrics can be implemented by the governance-boundary instrument or
another host measurement layer. RASHOMON defines their epistemic meaning; it
does not require a specific runtime ledger implementation.
...
- governance-boundary instrument closure specification - action-boundary closure checks
