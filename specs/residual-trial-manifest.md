...
It may also name external execution-evidence artifacts, such as adversarial
review dispatch ledgers, through perspective artifact references or a
consumer-side Action Packet. Those ledgers are not residuals themselves; they
prove whether the claimed perspectives actually ran.
...
The governance-boundary instrument may turn these signals into residual trial
scoring: a route-quality profile over residual yield, closure strength, manifest
strength, risk penalty, and cost-normalized residual yield. The score is not a
truth probability; it is evidence for route selection and future calibration.
...
- route names can be checked by the governance-boundary instrument's Product
  Router
- adversarial review dispatch ledger references can be checked by the
  governance-boundary instrument's Action Packets
